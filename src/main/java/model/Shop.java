...
public class Shop {
    ...
    private List<Item> createShopInventory() {
        ...
        // Add some potions
        items.add(new Potion("Health Potion", "A basic healing potion.", 30, 1, "images/potions/ManaPotion.png", 25));
        ...
        // Add weapons
        items.add(new Weapon("Short Sword", "A basic but reliable weapon.", 10, 20, DamageType.SLASHING, "images/weapons/Greatsword.png", 40));
        items.add(new Weapon("Dagger", "A stealthy weapon.", 7, 30, DamageType.PIERCING, "images/weapons/DualDaggers.png", 30));
